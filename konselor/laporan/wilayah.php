...
<div class="clearfix"></div>
    <div class="row">
        <div class="col-md-12 ">
            <div class="x_panel">
            	<form action="wilayah.php?go" method="post">
	                <div class="x_title">
															...
															if(isset($_POST['submit'])){
													            if(isset($_GET['go'])){
													                ...
													                if(!empty($salah)){
														                ...
														                INNER JOIN tb_registrasi ON tb_kdrt_kti.id_registrasi = tb_registrasi.id_registrasi 
														                INNER JOIN tb_identitas_survivor ON tb_identitas_survivor.id_registrasi = tb_kdrt_kti.id_registrasi WHERE id_kabupaten = '$kabupaten' AND $query_input GROUP BY tb_kdrt_kti.id_registrasi ORDER BY hari_tanggal";
														                ...
														                INNER JOIN tb_registrasi ON tb_kdrt_kta.id_registrasi = tb_registrasi.id_registrasi 
														                INNER JOIN tb_identitas_survivor ON tb_identitas_survivor.id_registrasi = tb_kdrt_kta.id_registrasi WHERE id_kabupaten = '$kabupaten' AND $query_input GROUP BY tb_kdrt_kta.id_registrasi ORDER BY hari_tanggal";
														                ...
														                INNER JOIN tb_registrasi ON tb_kdrt_kts.id_registrasi = tb_registrasi.id_registrasi 
														                INNER JOIN tb_identitas_survivor ON tb_identitas_survivor.id_registrasi = tb_kdrt_kts.id_registrasi WHERE id_kabupaten = '$kabupaten' AND $query_input GROUP BY tb_kdrt_kts.id_registrasi ORDER BY hari_tanggal";
														                ...
														                INNER JOIN tb_registrasi ON tb_kdrt_lain.id_registrasi = tb_registrasi.id_registrasi 
														                INNER JOIN tb_identitas_survivor ON tb_identitas_survivor.id_registrasi = tb_kdrt_lain.id_registrasi WHERE id_kabupaten = '$kabupaten' AND $query_input GROUP BY tb_kdrt_lain.id_registrasi ORDER BY hari_tanggal";
														                ...
														                INNER JOIN tb_registrasi ON tb_ktp.id_registrasi = tb_registrasi.id_registrasi 
														                INNER JOIN tb_identitas_survivor ON tb_identitas_survivor.id_registrasi = tb_ktp.id_registrasi WHERE id_kabupaten = '$kabupaten' AND $query_input GROUP BY tb_ktp.id_registrasi ORDER BY hari_tanggal";
														                ...
														                INNER JOIN tb_registrasi ON tb_kta.id_registrasi = tb_registrasi.id_registrasi 
														                INNER JOIN tb_identitas_survivor ON tb_identitas_survivor.id_registrasi = tb_kta.id_registrasi WHERE id_kabupaten = '$kabupaten' AND $query_input GROUP BY tb_kta.id_registrasi ORDER BY hari_tanggal";
