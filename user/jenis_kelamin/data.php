...
<div class="">
	...
	<div class="row">
		<div class="col-md-12 ">
			<div class="x_panel">
				<div class="x_title">
					<h2>Kelola Data Jenis Kelamin </h2>
							...
							<div class="card-box table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									<tbody>
										...
										$sql_jenis_kelamin = mysqli_query($mysqli, $query) or die(mysqli_error($query));
										if(mysqli_num_rows($sql_jenis_kelamin) > 0) {
										while ($row = mysqli_fetch_array($sql_jenis_kelamin)){
											
										?>
										<tr>
											<td >
												
												<a class="fa fa-edit edit_data"  data-toggle="modal" href="#myModal" id="custId" data-target="#myModal" data-id="<?=$row['id_jenis_kelamin'] ?>"></a> | 
												<a class="fa fa-trash" href="javascript:delete_id(<?=$row['id_jenis_kelamin']?>)" ></a>
											</td>
