							...
							<div class="card-box table-responsive">
								<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									<tbody>
										...
										$sql_layanan = mysqli_query($mysqli, $query) or die(mysqli_error($query));
										...
										<tr>
											<td >
												<a class="fa fa-edit edit_data"  data-toggle="modal" href="#myModal" id="custId" data-target="#myModal" data-id="<?=$row['id_layanan'] ?>"></a> | 
												<a class="fa fa-trash" href="javascript:delete_id(<?=$row['id_layanan']?>)" ></a>
											</td>
