                        ...
                        <div class="col-sm-12">
                            <form role="form" class=""  action="aksitambah.php" method="post">
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Jenis Layanan<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" id="nama_layanan" name="nama_layanan" required="required" type="text" value="" />
                                    </div>
                                </div>
                                <div class="ln_solid">
