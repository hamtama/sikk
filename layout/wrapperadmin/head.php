<?php 
@session_start();
if(@$_SESSION['Admin'] || @$_SESSION['Konselor']){
...
if (!$active){
			...
			if(!@$_SESSION['Admin'] && @$_SESSION['User']){
				?><script>alert("Anda tidak dapat masuk ke halaman ini");location.href="../../layout/wrapperuser/wrapper.php";</script><?php
				;
			}
			if(!@$_SESSION['Admin'] && @$_SESSION['Konselor']){
				...
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a href="../../index.php" class="site_title"> <img src="../../assets/images/logo-rdu.png"  alt="..." style="height: 50px"> <span>SIMKTPA</span></a>
						</div>
