							...
							<div class="card-box">
								<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									<tbody>
										...
										LEFT JOIN tb_layanan_pasien ON tb_layanan_pasien.id_registrasi = tb_registrasi.id_registrasi WHERE 1 ORDER BY tb_registrasi.id_registrasi DESC";
										...
										<tr>
											...
											<td><?php if($row['pekerjaan_pelaku'] == "Lainnya"){echo $row['pekerjaan_lainnya_pelaku'];} else {echo $row['pekerjaan_pelaku'];} ?></td>
											<td><?php if($row['status_perkawinan_pelaku'] == "Lainnya"){echo $row['status_lainnya_pelaku'];} else { echo $row['status_perkawinan_pelaku'];} ?></td>
											<td><?php if($row['hubungan_korban'] == "Lainnya"){ echo $row['hubungan_lainnya'];} else {echo $row['hubungan_korban'];} ?> </td>
											<?php  
								...
								<div class="modal fade bs-example-modal-lg"  id="export" tabindex="-1" role="dialog" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h4 class="modal-title">Cetak Data Pelaku</h4>
												<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
												</button>
											</div>
											<div class="modal-body">
													...
													<form id="action" action="" method="post">
														...
														<div class="col-md-12">
										                    ...
										                    <div class="col-md-12" align="center">
										                    	<button class="btn btn-outline-info btn-lg" id="excel" name="submit" type="submit"><i class="fa fa-table"></i> Excel</button>
...
$(document).ready(function(){
	$('#excel').click(function(){
		$('#action').attr('action','excel_pelaku.php');
	});
	$('#pdf').click(function(){
		$('#action').attr('action','pdf_pelaku.php');
	});
});
</script>
<?php
