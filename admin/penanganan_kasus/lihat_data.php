                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <th>Hubungan Korban</th>
                                    <th>Lokasi Kasus</th>
                                </tr>
                                <tr>
                                    <td><?php echo $baris['nama_pelaku'] ?></td>
                                    <td><?php echo $baris['alamat_pelaku'] ?></td>
                                    <td><?php if($pekerjaan_pelaku == 'Lainnya'){ echo $baris['pekerjaan_lainnya_pelaku']; }else {echo $baris['pekerjaan_pelaku'];} ?></td>
                                    <td><?php if($hubungan_korban == 'Lainnya'){ echo $baris['hubungan_lainnya']; }else {echo $baris['hubungan_korban'];} ?></td>
                                    <td><?php if($lokasi_kasus == 'Lainnya'){ echo $baris['lokasi_lainnya'];} else { echo $baris['lokasi_kasus'];} ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
